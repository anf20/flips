...
<body class="bg-gradient-to-br from-blue-500 to-indigo-600 font-sans antialiased flex items-center justify-center min-h-screen">
    <div class="w-full max-w-2xl bg-white p-8 rounded-lg shadow-xl text-center">
        @yield('content') {{-- Ini adalah tempat konten dari child view (@section('content')) akan dirender --}}
    </div>

    @stack('scripts') {{-- Ini untuk script JavaScript yang didorong dari child view --}}
</body>
</html>